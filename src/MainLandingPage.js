...
export default ({
  ...
  primaryButtonText = "Download Labeler",
  ...
  heading = "ClearBot YOLO",
  description = "You only label once.Easily increase your labeling speed by up to 4X."
}) => {
  /*
      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          ...
          <HeroRow>
            <UpdateNotice>
              <UpdateNoticeIcon />
              Last updated on 4th of May 2021 - Added React Webpage
            </UpdateNotice>
            <TextColumn>
